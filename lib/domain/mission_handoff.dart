...
class MissionHandoff {
  ...
  const MissionHandoff(
      ...
      required this.authoritySnapshotHash,
      required this.missionStateHash,
      required this.permittedActionTypes,
      required this.permittedToolIds,
  ...
  bool get isAcceptable =>
      status == HandoffStatus.issued && DateTime.now().isBefore(expiresAt);
}
