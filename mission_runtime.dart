...
class MissionRuntimeContract {
  ...
  MissionRuntimeState apply(
    ...
    if (next == null) {
      throw StateError('INVALID_RUNTIME_TRANSITION:${state.name}:${event.name}');
    }
    return next;
  }

  static const _transitions = <MissionRuntimeState, Map<RuntimeEventType, MissionRuntimeState>>{
