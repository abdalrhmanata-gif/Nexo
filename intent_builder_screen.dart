    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const Text('Describe the outcome naturally. NEXO will convert it into a bounded Mission.'),
          const SizedBox(height: 16),
          TextField(
            controller: _controller,
            maxLines: 4,
            decoration: const InputDecoration(
              hintText: 'Example: Get 5 new customers from Norway within two weeks.',
                ...
                children: draft.authorityRequests
                    .map((r) => ListTile(
                          ...
                          leading: CircleAvatar(
                            child: Text(authorityClassLabel(r.authorityClass)[0]),
                          ),
                          title: Text(r.action),
                          subtitle: Text('${authorityClassLabel(r.authorityClass)} • ${r.reason}'),
