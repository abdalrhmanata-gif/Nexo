...
void main() {
  test('version fencing rejects stale commands', () {
    ...
    final s = seed();
    kernel.apply(s, const MissionKernelCommand(
      commandId: 'c1', missionId: 'm1', organizationId: 'o1', expectedVersion: 0,
      type: MissionKernelCommandType.start, actorId: 'u1'));
    expect(() => kernel.apply(s, const MissionKernelCommand(
      commandId: 'c2', missionId: 'm1', organizationId: 'o1', expectedVersion: 0,
      type: MissionKernelCommandType.start, actorId: 'u1')),
  ...
  test('duplicate command is idempotent', () {
    final kernel = MissionKernel();
    final s = seed();
    final a = kernel.apply(s, const MissionKernelCommand(
      commandId: 'same', missionId: 'm1', organizationId: 'o1', expectedVersion: 0,
      type: MissionKernelCommandType.start, actorId: 'u1'));
    final b = kernel.apply(s, const MissionKernelCommand(
      commandId: 'same', missionId: 'm1', organizationId: 'o1', expectedVersion: 0,
      type: MissionKernelCommandType.start, actorId: 'u1'));
  ...
  test('completion requires verification', () {
    ...
    expect(() => kernel.apply(s, const MissionKernelCommand(
      commandId: 'complete', missionId: 'm1', organizationId: 'o1', expectedVersion: 0,
      type: MissionKernelCommandType.complete, actorId: 'u1')),
      throwsA(isA<MissionKernelException>()));
  });
  ...
  test('replan cannot expand budgets', () {
    ...
    final s = seed();
    expect(() => kernel.apply(s, const MissionKernelCommand(
      commandId: 'replan', missionId: 'm1', organizationId: 'o1', expectedVersion: 0,
      type: MissionKernelCommandType.replan, actorId: 'u1', remainingActions: 11)),
      throwsA(isA<MissionKernelException>()));
  });
  ...
  test('provider switch does not mutate authority', () {
    ...
    final d = kernel.apply(s, const MissionKernelCommand(
      commandId: 'route', missionId: 'm1', organizationId: 'o1', expectedVersion: 0,
      type: MissionKernelCommandType.selectIntelligence, actorId: 'system',
      selectedAgentId: 'agent-b', selectedProvider: 'provider-b', selectedModel: 'model-b'));
  ...
  test('cross-tenant binding fails closed', () {
    final kernel = MissionKernel();
    expect(() => kernel.apply(seed(), const MissionKernelCommand(
      commandId: 'x', missionId: 'm1', organizationId: 'other', expectedVersion: 0,
      type: MissionKernelCommandType.start, actorId: 'u1')),
      throwsA(isA<MissionKernelException>()));
  });
}
