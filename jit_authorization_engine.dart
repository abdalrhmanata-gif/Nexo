...
class JitAuthorizationEngine {
  JitAuthorizationDecisionRecord evaluate(JitAuthorizationRequest r, {
    ...
    if (!delegationActive) {
      ...
      rules.addAll(['delegation.active', 'passport.active', 'lease.active', 'policy.allow', 'approval.satisfied']);
    }
